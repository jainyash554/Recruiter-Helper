...
<div class="form-group">
	    ...
	    <div class="col-sm-8">
	     <input type="text" class="form-control" name="totalexp" value="<?php echo $totalexp?>" > 
	    </div>
   </div>
