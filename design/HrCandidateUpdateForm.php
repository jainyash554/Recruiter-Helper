            ...
            // $conn   = new mysqli("localhost", "root", "", "tech_db");
	          ...
	          $sql = "UPDATE tech_candidates
					...
					SET    tech_can_fullname = '$name', 
					       ...
					       tech_can_appliedposition='$positionforapply',
...
/*$sql3 = 
"UPDATE tech_can_exp SET tech_can_exp_nameofcompany='".$companyname1."',
						 tech_can_exp_designation='".$designation1."'
						 tech_can_exp_years='".$exprience1."'



 WHERE tech_can_meta_key='".$key."' AND tech_can_id = '".$_GET['tech_can_id']."'";
*/

/*"UPDATE tech_candidate_meta SET tech_can_meta_value='$training' WHERE tech_can_meta_key='Traing_Period' AND tech_can_id=tech_can_id = '".$_GET['tech_can_id']."'";
"UPDATE tech_candidate_meta SET tech_can_meta_value='$bound' WHERE tech_can_meta_key='Bond' AND tech_can_id=tech_can_id = '".$_GET['tech_can_id']."'";
*//*UPDATE tech_candidate_meta SET tech_can_meta_value='$court' WHERE tech_can_meta_key='Court_Case' AND tech_can_id=tech_can_id = '".$_GET['tech_can_id']."';
UPDATE tech_candidate_meta SET tech_can_meta_value='$multishift' WHERE tech_can_meta_key='Ready_For_MultiShift' AND tech_can_id=tech_can_id = '".$_GET['tech_can_id']."';
UPDATE tech_candidate_meta SET tech_can_meta_value='$skill' WHERE tech_can_meta_key='Skills' AND tech_can_id=tech_can_id = '".$_GET['tech_can_id']."';
UPDATE tech_candidate_meta SET tech_can_meta_value='$currentctc' WHERE tech_can_meta_key='Current_CTC' AND tech_can_id=tech_can_id = '".$_GET['tech_can_id']."';
UPDATE tech_candidate_meta SET tech_can_meta_value='$expectedctc' WHERE tech_can_meta_key='Expected_CTC' AND tech_can_id=tech_can_id = '".$_GET['tech_can_id']."';
UPDATE tech_candidate_meta SET tech_can_meta_value='$hearabout' WHERE tech_can_meta_key='Hear_About_Company' AND tech_can_id=tech_can_id = '".$_GET['tech_can_id']."'  */                          
					       			       
	/*if($conn->query($sql))
	{
		echo "data update candidate table successfully";
	}
	else {
				                	echo "Error: "  . $sql . "<br>" .$conn->error;
				           			}*/
...
<div class="login_d1">
	...
	<div class="col-sm-12">
		<h1>Hr Candidate Updation Form</h1>
	</div>
	</div>
 ...
 <div class="form-group">
   ...
   <div class="form-group">
	    ...
	    <div class="col-sm-8">
	      <input type="text" class="form-control" name="date" disabled value="<?php echo date("d/m/Y", strtotime($date))?>" >
	    </div>
   </div>
 ...
 <div class="form-group">
             ...
             <div class="form-group">
			   ...
			   <div class="form-group">
				    ...
				    <div class="col-sm-3">
				     <select class="form-control" name="techuser" required>
						    <option value="1">Tech_User1</option>
						    <option value="2">Tech_User2</option>
						    <option value="3">Tech_User3</option>
						  </select>
				    </div>
			   </div>
			  ...
			  <div class="form-group">
			   ...
			   <div class="form-group">
				    <label class="control-label col-sm-5" for="skills">Hr-Comments:</label>
				    <div class="col-sm-3">
				    <textarea  name="comments"><?php echo $hrcomment; ?>
				    </textarea>
				    </div>
			   </div>
