...
//$conn   = new mysqli("localhost", "root", "", "tech_db");
	...
	$sql = "UPDATE tech_candidates SET tech_can_technical_comment = '$techhrcomments' WHERE                            tech_can_id = '".$_GET['tech_can_id']."'";
	if($conn->query($sql))
	{
		 header("Location: TrCandidateList.php");
		 exit();
...
<div class="login_d1">
	...
	<div class="col-sm-12">
		<h1>Tr Candidate Updation Form</h1>
	</div>
	</div>
...
<div class="form-group">
	    <label class="control-label col-sm-4" for="positionforapply">Total Exprience:</label>
	    <div class="col-sm-8">
	     <input type="text" class="form-control" name="totalexp" value="<?php echo $totalexp?>" disabled> 
	    </div>
   </div>
...
<!-- 
 ...
 <div class="form-group">
             ...
             <div class="form-group">
			   ...
			   <div class="form-group">
				    <label class="control-label col-sm-5" for="HrComments">HrComments:</label>
				    <div class="col-sm-3">
				    <textarea disabled name="comments">
				    <?php echo $hrcomment; ?>
				    </textarea>
				    </div>
			   </div>
			  ...
			  <div class="form-group">
				    <label class="control-label col-sm-5" for="comments"> Technical Comments:</label>
				    <div class="col-sm-3">
